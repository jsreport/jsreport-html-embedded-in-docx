...
_jsreportStudio2.default.previewListeners.push(function (request, entities) {
  ...
  if (_jsreportStudio2.default.extensions['html-embedded-in-docx'].options.preview.enabled === false) {
    return;
  }

  if (_jsreportStudio2.default.extensions['html-embedded-in-docx'].options.preview.showWarning === false) {
    return;
  }
